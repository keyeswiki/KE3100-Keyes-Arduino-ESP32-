...
- 方法一：从我们提供的资料中，有Android apk安装包：

![Img](../media/cou123.png)

将 “**IOT farm.apk**” 文件通过USB数据线转移到手机上，然后再参照提示安装Android APP。

![Img](../media/A00.png)

- 方法二：也可以复制链接：`https://xiazai.keyesrobot.cn/APP/IOT%20farm.apk` 到浏览器中下载“**IOT farm.apk**”文件，将 “**IOT farm.apk**” 文件通过USB数据线转移到手机上，然后再参照提示安装Android APP。

![Img](../media/A00-1.png)

- 方法三：扫下面的二维码（**注意：当我们扫码下载的时候需要使用手机浏览器的扫码功能扫码打开，使用微信扫码可能无效。** ）来下载“**IOT farm.apk**”文件，然后再参照提示安装Android APP。

- 方法四：进入链接：[https://www.keyesrobot.cn/zh-cn/latest/docs/APP.html](https://www.keyesrobot.cn/zh-cn/latest/docs/APP.html)，找到 “IOT farm” 所在行，点击对应的 “**点击下载**”按钮，即可下载 “**IOT farm.apk**” 文件，然后再参照提示安装Android APP。
...
在 APP Store 中搜索 “**IOT farm**”，出现下载界面，点击 ![Img](../../media/download.png) 下载即可。

- 方法二：进入链接：[https://www.keyesrobot.cn/zh-cn/latest/docs/APP.html](https://www.keyesrobot.cn/zh-cn/latest/docs/APP.html)，找到 “IOT farm”，点击对应的 “App Store” ，出现下载界面，点击 ![Img](../../media/download.png) 下载即可。
